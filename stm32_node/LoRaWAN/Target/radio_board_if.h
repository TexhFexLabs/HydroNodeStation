 ...
 */
/* TODO [PCB]: Wio-E5 = RBI_CONF_RFO_HP (nur HP). Custom PCB mit BGS12SN6E = ggf. RBI_CONF_RFO_LP_HP prüfen */
 ...
 * 1: DCDC supported
 */
/* TODO [PCB]: Wio-E5 = 1U (hat DC-DC). Custom PCB prüfen ob DC-DC verbaut ist */
...
/* Wio-E5 Mini RF switch: PA4 = CTRL1, PA5 = CTRL2 */
/* TODO [PCB]: Custom PCB mit BGS12SN6E (SPDT, 1 Pin): nur einen CTRL-Pin definieren (z.B. PC13).
 *             RF_SW_CTRL2 entfällt, RBI_ConfigRFSwitch() entsprechend anpassen. */
