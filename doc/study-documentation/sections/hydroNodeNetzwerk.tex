...
\end{verbatim}
        \textbf{Wichtig:} \textit{Raw Message Delivery} muss \textbf{deaktiviert} bleiben — das Backend benötigt den vollständigen SNS-Envelope mit Metadaten.
...
\section*{KI-gestützte Analyse in der HydroNode App}
  ...
  (\emph{THRESHOLD\_BREACH}) – wird die Anomalie serverseitig an Amazon Bedrock
  ...
  Der System-Prompt ist je nach Installation unterschieden: Bei
  ...
  von 0–1, einen Luftqualitätsscore (\emph{air\_quality\_score}), die Erkennung
