...
\begin{table}[H]
  ...
  \begin{tabular}{llll}
    ...
    \multirow{5}{*}{2}
      ...
      & UV-Index (×100)   & u16, $÷100 = \text{UVI}$     & 8–9 \\
    \hline
    ...
    \multirow{3}{*}{4}
      ...
      & Typ.\ Partikelgröße & u16, $1\,\text{nm}$ ($\div 1000 = \mu\text{m}$) & 30–31 \\
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{lll}
    ...
    \hline
    $\geq 3400\,\text{mV}$ (normal) & 5~min & Vollbetrieb, alle Sensoren \\
    $< 3400\,\text{mV}$ (niedrig)  & 10~min & Interval $\times 2$ \\
    $< 3000\,\text{mV}$ (kritisch) & 60~min & Interval $\times 12$, \texttt{tx\_counter} reset (nur fPort~2) \\
    \hline
  \end{tabular}
...
Das Debug-Profil ist insbesondere nützlich, um Sensoren nach dem Einbau ins Gehäuse zu verifizieren, UV-Index-Kalibrierungen zu prüfen und Plausibilitätschecks im Außenbetrieb durchzuführen, ohne auf den 5-Minuten-Sendezyklus warten zu müssen.
