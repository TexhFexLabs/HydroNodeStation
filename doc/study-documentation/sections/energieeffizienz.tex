...
\subsection*{Erwartetes Verhalten des Custom PCBs}
...
Der theoretisch berechnete Gesamtschlafstrom von $\approx 5{,}67\,\mu\text{A}$ wird am Custom PCB angestrebt und nach Lieferung mit dem PPK2 messtechnisch verifiziert (s.\ Kapitel~\ref{cha:testing}).
