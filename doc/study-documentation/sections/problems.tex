...
\section*{Offener Punkt: UV-transparentes Glas für den UV-Sensor}

\textbf{Problem:} Der UV-Sensor LTR390 muss geschützt verbaut werden und trotzdem UV-Licht empfangen können. Normales Glas oder transparentes PETG blockiert einen großen Teil der UV-Strahlung und verfälscht so die Messwerte.

\textbf{Stand:} Das passende UV-transparente Glas (Quarzglas oder Borosilikatglas) würde mit Versand ca.\ 50 Euro kosten. Aktuell werden günstigere Alternativen getestet, zum Beispiel eine gefertigte Plexiglasabdeckung für den Sensorbereich sowie dünne UV-transparente Folien oder andere optische Materialien, die UV-A und UV-B durchlassen. Dieses Detail ist für die Genauigkeit der UV-Messung im Feldtest relevant.
