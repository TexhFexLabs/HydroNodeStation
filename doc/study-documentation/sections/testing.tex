...
\begin{itemize}
  ...
  \item \textbf{LTR390:} UV-Index wird korrekt berechnet und kalibriert. UV-Rohwerte reagieren auf UV-Exposition. Die Berechnung wurde während des Projekts refaktoriert, sodass der Sensor direkt den UV-Index (UVI) ausgibt.
...
\begin{figure}[H]
  ...
  \fbox{\parbox{0.6\linewidth}{\centering\vspace{2cm}
    \textit{[Platzhalter: Screenshot des Live-Dashboards mit Feldtest-Messdaten]}
    \vspace{2cm}}}
