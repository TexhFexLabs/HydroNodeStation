...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.6\linewidth}{\centering\vspace{2cm}
    \textit{[Platzhalter: 3D-Render des Stevenson-Screen-Gehäuses aus Fusion 360]}
    \vspace{2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.6\linewidth}{\centering\vspace{2cm}
    \textit{[Platzhalter: Foto der montierten Station im Außeneinsatz]}
    \vspace{2cm}}}
  \caption{Montierte HydroNodeStation01 im Außeneinsatz}
  \label{fig:station-outdoor}
\end{figure}

\textbf{Offener Punkt: UV-transparentes Glas.} Der LTR390-UV-Sensor benötigt Schutz, muss aber UV-Licht empfangen können. Normales Glas und PETG blockieren einen großen Teil der UV-Strahlung. Als Zwischenlösung wurde eine Plexiglasabdeckung gefertigt und eingepasst. Günstigere UV-transparente Folien oder optische Materialien werden weiter evaluiert (s.\ Kapitel~\ref{cha:probleme}).
